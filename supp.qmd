...
# Plot points
points <- r_df  %>% dplyr::filter(((x > 124 & x < 125) | (x > 135 & x < 136)) & (y > -30 & y < -29))
...
for (i in 1:nrow(points)) {
  locs[[i]] <- NicheMapR::micro_silo(loc = c(points[i,1], points[i,2]), dstart = "01/01/2000", dfinish = "01/01/2021", email = "pieter.arnold@anu.edu.au")
}
...
for(i in 1:length(locs)) {
  ...
  ecto_heat_activity[[i]] <- ectotherm( Ww_g = Ww_g,
   ...
   head(data.frame(ecto_heat_activity[[1]]$metout))
