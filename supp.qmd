...
p1 <- ggplot(environ_lizard2) +
  ...
  annotate("text", x = as.POSIXct("2016-01-04"), y = 10, label = paste0("Median Daily Activity (%): ", round(median(per_active_day$per_active), digits =2)), hjust = 0, size = 12) +
  annotation_custom(g, xmin = as.POSIXct("2016-01-04"), xmax = as.POSIXct("2016-01-13"), ymin = 0.5, ymax = 8) +
